...
class RecomendationController extends Controller
{
	 ...
	 * @return Recomendation the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Recomendation::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Recomendation $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='recomendation-form')
		{
