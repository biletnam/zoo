...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php if ($model->isNewRecord): ?>
			<input id="Cure_id_anemnes" type="hidden" name="Cure[id_anemnes]" value="<?php echo $anemnes; ?>"></input>
		<?php else: ?>
			<input id="Cure_id_anemnes" type="hidden" name="Cure[id_anemnes]" value="<?php echo $model->id_anemnes; ?>"></input>
		<?php endif; ?>	
	</div>
