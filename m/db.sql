...
REPLACE INTO `anemneses` (`id_anemnes`, `id_animal`, `date`, `description`, `summ`, `id_medic`, `temperature`, `color_sl`, `skin`) VALUES
	...
	(81, 11, '2014-07-21', 'wefwefwefefw', 12.00, 1, 36.6, '', ''),
...
-- Dumping data for table zoo.animals: ~9 rows (approximately)
/*!40000 ALTER TABLE `animals` DISABLE KEYS */;
REPLACE INTO `animals` (`id_animal`, `name`, `id_type`, `sex`, `age`, `reg_num`, `date_reg`, `date_death`, `id_priv`, `id_master`, `description`) VALUES
	...
	(11, 'тобик', 1, 1, 3, '12', '2014-06-04', '0000-00-00', NULL, 5, ''),
...
REPLACE INTO `cure` (`id_cure`, `id_anemnes`, `rp`, `ds`) VALUES
	(1, 1, 'fuck', 'lock'),
	(2, 1, 'gruuuuu', 'ass'),
	(3, 1, 'dff', 'fee'),
...
-- Dumping data for table zoo.masters: ~3 rows (approximately)
/*!40000 ALTER TABLE `masters` DISABLE KEYS */;
REPLACE INTO `masters` (`id_master`, `firstname`, `surname`, `lastname`, `city`, `street`, `n_home`, `n_apart`, `telephone_1`, `telephone_2`, `telephone_3`, `description`) VALUES
	...
	(5, 'cdtnf', 'сергеевна', 'cntgfytyrh', 'Синельниково', 'Ленина', '1', 15, '09954212114', '', '', '');
...
REPLACE INTO `medics` (`id_medic`, `firstname`, `surname`, `lastname`, `description`, `work`) VALUES
...
-- Dumping data for table zoo.priv: ~9 rows (approximately)
/*!40000 ALTER TABLE `priv` DISABLE KEYS */;
REPLACE INTO `priv` (`id_priv`, `date`, `description`, `id_animal`, `complete`, `crazy`) VALUES
...
REPLACE INTO `types` (`id_type`, `name`, `description`) VALUES
	(1, 'Cat', NULL),
	(2, 'Dog', NULL),
	(3, 'Goat', NULL),
	(4, 'Хомяк', 'животное'),
...
-- Dumping data for table zoo.users: ~0 rows (approximately)
